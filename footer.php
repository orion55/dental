...
if (orion_display_prefooter() == true) :?>
    ...
    /* Rendering */
    ?>
    <div class="prefooter section <?php echo esc_attr($orion_prefooter_color_class); ?>"
         style="background-color:<?php echo esc_attr($orion_prefooter_bg_color); ?>">
        <div class="container">
            <div class="row">
...
<div class="section site-footer <?php echo esc_attr($orion_footer_color_class); ?>"
     style="background-color: <?php echo esc_attr($orion_footer_bg_color); ?>;">
    ...
    if (orion_get_option('copyrightarea_switch', false) == true) :?>
        ...
        <div class="copyright-footer section <?php echo esc_attr($copyrightfooter_color_class); ?>"
             style="background-color: <?php echo esc_attr($orion_c_footer_bg_color); ?>;">
            <div class="container">
                <div class="row">
                    ...
                    <?php if ($sidebars_active == 0) : ?>
                        <div class="col-md-12 text-center">
                            ...
                            <p style="text-align: center;" class="font-2">
                                <small>Made with <i class="orionicon orionicon-icon_heart"></i> by <a
                                            href="<?php echo esc_url($orion_url) ?>" target="_blank">OrionThemes</a>
                                </small>
                            </p>
                        </div>
                    <?php endif; ?>
